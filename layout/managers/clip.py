...
class ClipLM(root.LayoutManager):
    ...
    particularly with managers in the :mod:`~layout.managers.fixed` or 
    :mod:`~layout.managers.jitter` modules, the drawing is outside the
    reserved space, this manager ensures any content that does overlap
    is trimmed."""
